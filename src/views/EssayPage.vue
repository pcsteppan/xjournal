<template>
  <div id="essay--wrapper" class="serif ma3 ma0-ns">
    <div class="fl-ns w-25-ns w-0 o0 ma0 pa0">&nbsp;</div>
    <div id="essay--display-wrapper" class="fl-ns w-25-ns pb0-ns">
      <h1 class="f3-ns f4 lh-display" style="white-space: pre-wrap;">Beholder, or Beholden?
What We Bring to Art and What We
Come Away With</h1>
      <span class="author i f6">Nicholas Nurre, ’18</span>
    </div>

    <div id="essay--body-wrapper" class="fl-ns w-50-ns lh-copy serif f4">
      <p class="measure pb4">
